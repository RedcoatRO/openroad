...
import TCOCalculator from '../components/TCOCalculator'; // Am importat noua componentă
        ...
        <>
            <section className="relative bg-cover bg-center text-white py-24" style={{ backgroundImage: "url('https://picsum.photos/seed/benefits/1920/1080')" }}>
                ...
                <div className="relative container mx-auto px-4 z-10 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold">Avantaje pentru companii</h1>
                    <p className="mt-4 text-lg text-blue-100 max-w-2xl mx-auto">De ce să alegi închirierea auto pe termen lung?</p>
            ...
            <section className="py-20 bg-bg-alt dark:bg-gray-800" aria-labelledby="tco-title">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 id="tco-title" className="text-3xl font-bold text-text-main dark:text-white">Calculator Cost Total de Proprietate (TCO)</h2>
                        <p className="mt-4 text-muted dark:text-gray-400">Estimează și compară costurile reale între leasingul operațional și achiziția directă a unui vehicul. Vezi exact cât poți economisi.</p>
                    </div>
                    <TCOCalculator />
                </div>
            </section>
