...
// --- Date Simulate pentru Grafice ---
const popularVehiclesData = adminDataService.getVehicles()
    .sort((a, b) => b.popularity - a.popularity)
    .slice(0, 5)
    .map(v => ({ name: v.model, Popularitate: v.popularity }));

const conversionData = [
    { name: 'Săpt. 1', Rata: 2.5 },
    { name: 'Săpt. 2', Rata: 2.8 },
    { name: 'Săpt. 3', Rata: 2.3 },
    { name: 'Săpt. 4', Rata: 3.1 },
];
