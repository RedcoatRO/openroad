...
const ServiceLeasingPage: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <section data-editable-id="leasing-hero-bg" className="relative bg-cover bg-center text-white py-24" style={{ backgroundImage: `url('${getContent('leasing-hero-bg')}')` }}>
                <div className="absolute inset-0 bg-blue-900/80"></div>
                <div className="relative container mx-auto px-4 z-10 text-center">
                    <h1 data-editable-id="leasing-hero-title" className="text-4xl md:text-5xl font-bold">{getContent('leasing-hero-title')}</h1>
                    <p data-editable-id="leasing-hero-subtitle" className="mt-4 text-lg text-blue-100 max-w-2xl mx-auto">{getContent('leasing-hero-subtitle')}</p>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 data-editable-id="leasing-benefits-title" className="text-3xl font-bold text-text-main dark:text-white">{getContent('leasing-benefits-title')}</h2>
                    </div>
            ...
            <section className="py-20 bg-bg-alt dark:bg-gray-800">
                <div className="container mx-auto px-4">
                     <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 data-editable-id="leasing-how-title" className="text-3xl font-bold text-text-main dark:text-white">{getContent('leasing-how-title')}</h2>
                    </div>
            ...
            <section className="bg-primary text-white">
                <div className="container mx-auto px-4 py-16 text-center">
                    <h2 data-editable-id="leasing-cta-title" className="text-3xl font-bold">{getContent('leasing-cta-title')}</h2>
                    <p data-editable-id="leasing-cta-subtitle" className="mt-4 max-w-2xl mx-auto text-blue-100">{getContent('leasing-cta-subtitle')}</p>
