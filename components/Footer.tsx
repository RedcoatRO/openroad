                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start">
                                ...
                                <a href="mailto:office@openroad.ro" className="hover:text-primary transition-colors">office@openroad.ro</a>
                            </li>
                            <li className="flex items-start">
                                <PhoneIcon className="w-4 h-4 mr-3 mt-1 text-primary flex-shrink-0" />
                                <a href="tel:+40792313921" className="hover:text-primary transition-colors">+40 792 313 921</a>
                            </li>
                            <li className="flex items-start">
