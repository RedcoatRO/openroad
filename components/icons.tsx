...
export const EuroIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 10h12"/><path d="M4 14h9"/><path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/></svg>
);
...
export const PiggyBankIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 5c-1.5 0-2.8 1-3.4 2.3A5 5 0 0 0 8 8c0 1.4.6 2.6 1.5 3.5c-2.1 2.8-4 2.4-4.5 2.5C4.2 14.1 3 15.2 3 16.5V17h11.2c.4 1.5 1.7 2.6 3.3 2.6c1.8 0 3.2-1.4 3.2-3.2c0-1.2-.7-2.3-1.7-2.8c-.3-.1-.5 0-.6-.3c-.2-.4-.2-.8.2-1.2c.6-.5 1.1-1.3 1.1-2.2C22 7.2 20.7 5 19 5"/><path d="M10 9a2 2 0 1 0 0 4 2 2 0 1 0 0-4"/><path d="M2 13.5V17h4"/></svg>
);

export const CarSilhouetteIcon: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 512 512" fill="currentColor" {...props}>
    <path d="M116.5 292.5c-23.3 0-42.3 19-42.3 42.3s19 42.3 42.3 42.3 42.3-19 42.3-42.3-19-42.3-42.3-42.3zm279.1 0c-23.3 0-42.3 19-42.3 42.3s19 42.3 42.3 42.3 42.3-19 42.3-42.3-19-42.3-42.3-42.3zm-42.9-85.8h-23.3v-42.9c0-11.8-9.6-21.4-21.4-21.4h-192c-11.8 0-21.4 9.6-21.4 21.4v42.9h-33.8c-11.8 0-21.4 9.6-21.4 21.4v85.8c0 11.8 9.6 21.4 21.4 21.4h32.7c3.9 31.2 32 54.7 65.3 54.7s61.4-23.5 65.3-54.7h101.9c3.9 31.2 32 54.7 65.3 54.7s61.4-23.5 65.3-54.7h23.3c11.8 0 21.4-9.6 21.4-21.4v-85.8c.2-11.8-9.5-21.4-21.3-21.4zM128.9 228c0-11.8 9.6-21.4 21.4-21.4h192c11.8 0 21.4 9.6 21.4 21.4v21.4h-234.8v-21.4z" />
  </svg>
);

export const ScaleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 16.5l4-4"/><path d="M12.5 12.79a2.5 2.5 0 0 1-3.58 0l-4.24-4.24a2.5 2.5 0 0 1 0-3.58l.88-.88a2.5 2.5 0 0 1 3.58 0l4.24 4.24a2.5 2.5 0 0 1 0 3.58l-.88.88Z"/><path d="M20 21v-4.5"/><path d="M3.5 3.5 2 2"/><path d="m8 8 2-2"/><path d="M4 21.5 2 22"/><path d="m16 4-2-2"/><path d="M22 8l-2-2"/></svg>
);
...
export const ArrowLeftRightIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="M16 21l4-4-4-4"/><path d="M20 17H4"/></svg>
);
...
export const CogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
);
...
export const Rotate3dIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16.466 7.5C15.643 4.237 13.952 2 12 2 9.239 2 7 6.477 7 12s2.239 10 5 10c.342 0 .677-.069 1-.2"/><path d="m11.5 2-3 4.5 4.5 3"/><path d="M22 12c0 4.418-4.03 8-9 8s-9-3.582-9-8 4.03-8 9-8c.342 0 .677.069 1 .2"/></svg>
);
...
export const BuildingOffice2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 18v-6H5v6"/><path d="M19 18v-6h-4v6"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M12 8h.01"/></svg>
);
...
// Iconițe noi pentru funcționalitățile avansate de admin
